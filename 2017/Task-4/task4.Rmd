...
We preprocess the passphrases, such that we bring each password in its canonical form 
first, that is, we split it into letters, sort them and paste them together. Then, we use 
the algorithm from part 1.
