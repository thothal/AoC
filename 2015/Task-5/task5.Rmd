...
1. First filter for the naughty digrams `ab`, `cd`, `pq` or `xy`.
1. For the remaining strings, remove strings which do not contain duplciated letters, or
not enough vowels.
1. Count the remaining strings.
...
We use the same overall idea, just adapting our regular expressions making use of 
backreferences as before.
